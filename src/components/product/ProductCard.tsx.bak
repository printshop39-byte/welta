    ...
    <article className="group flex h-full flex-col">
      ...
      >
        ...
        <div className="pt-4 sm:pt-5 flex flex-col gap-2 flex-1">
          <h3 className="font-serif text-[15px] sm:text-base lg:text-lg text-[var(--color-navy-ink)] leading-snug line-clamp-2 group-hover:text-[var(--color-gold-deep)] transition-colors">
            {product.name}
          </h3>
