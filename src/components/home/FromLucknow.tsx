  ...
  return (
    <section className="bg-[var(--color-ivory-soft)] border-y border-[var(--color-line)]">
      <Container className="py-16 sm:py-20 lg:py-24 max-w-4xl text-center">
        <p className="text-[10px] sm:text-[11px] uppercase tracking-[0.42em] text-[var(--color-gold-deep)] mb-6">
          From Lucknow
        </p>
        <p className="font-serif italic text-2xl sm:text-3xl lg:text-[36px] leading-[1.25] text-[var(--color-navy-ink)]">
